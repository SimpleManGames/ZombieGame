...
Gun::Gun(std::string name, int fireRate, int bulletsPerShot, float spread, float bulletDamage, float bulletSpeed, Engine2D::SoundEffect fireEffect, bool isUnlocked) :
	_name(name),
	_fireRate(fireRate),
